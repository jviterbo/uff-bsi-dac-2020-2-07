 ...
 * @author viter
 */
@WebServlet(name = "ConverteInvServlet", urlPatterns = {"/ConverteInvServlet"})
public class ConverteInvServlet extends HttpServlet {

    private static final long serialVersionUID = 1L;

    @EJB
    private ConverteInvBean convBean;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String msgConv = timestamp + ": " + request.getParameter("temp") + " graus Farenheit para " + convBean.fToC(tempIn) + " graus Celsius";
        listaConvBean.saveConv(msgConv);
        contConvBean.incContagem();
        out.println("<html><h1>Exemplo de uso de EJBs de Sessão</h1>");
        out.println("<h2>Servlet 2: Conversão de Temperatura - de Farenheit para Celsius</h2>");
        out.println("<p>[Stateless] O resultado da conversão de " + request.getParameter("temp") + " graus Farenheit para Celsius é " + convBean.fToC(tempIn) + "</p>");
        out.println("<p></p>");
